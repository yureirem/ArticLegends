"""
Django settings for fulltest project.
...
ROOT_URLCONF = 'fulltest.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "fulltest/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'fulltest.wsgi.application'
...
# CSRF_COOKIE_SECURE = False # Set to True in https